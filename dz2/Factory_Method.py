...
"""Библиотека abc (Abstract Base Classes) в Python предоставляет механизм для определения абстрактных базовых классов. 
Абстрактные базовые классы представляют собой классы, которые могут определять абстрактные методы, 
то есть методы без реализации."""
